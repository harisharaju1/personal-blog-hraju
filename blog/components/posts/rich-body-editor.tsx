    ...
    <div className="space-y-1.5">
      <div className="flex gap-1">
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded border px-2 py-0.5 text-xs font-mono transition-colors hover:bg-neutral-100 dark:hover:bg-neutral-700"
        >
          <span>&lt;/&gt;</span>
          <span>Code</span>
        </button>
      ...
      >
        <textarea
          ...
          rows={18}
          className="w-full resize-y rounded-md bg-transparent px-3 py-2 text-sm outline-none placeholder:text-neutral-400 disabled:cursor-not-allowed disabled:opacity-50 font-mono"
        ...
        {isUploading && (
          <div className="pointer-events-none absolute inset-0 flex items-center justify-center rounded-md bg-white/80 dark:bg-neutral-800/80">
